...
def generate_response(message, user_name, topic_keywords, model):
    """Genera una respuesta utilizando el modelo basado en el mensaje, el historial y las palabras clave."""
    ...
    try:
        prompt = f"""
        Eres un asistente útil y consistente. Responde al siguiente mensaje teniendo en cuenta este contexto:
